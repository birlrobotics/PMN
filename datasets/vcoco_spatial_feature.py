...
if __name__=="__main__":
    ...
    for subset in ["vcoco_train", "vcoco_test", "vcoco_val"]:
        ...
        for img_id in tqdm(set(image_ids)):
            ...
            spatial_feats, pose_to_human, pose_to_img, pose_to_obj = calculate_spatial_pose_feats(det_boxes, keypoints, img_wh)
            ...
            norm_keypoints[str(img_id)].create_dataset('pose_to_img', data=pose_to_img)
        save_data.close()
